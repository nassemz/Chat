...
public interface ServerMessages {
    ...
    public static final String  ConFailWhileCon                = "Connection to server failed press OK to exit chat application";
    public static final String   ConFaill                      = "Connection Failed...";
